...
namespace Roadkill.Tests.Unit.Text.Sanitizer
{
    public class HtmlWhiteListProviderTests
    {
        ...
        {
            // given
            _textSettings.HtmlElementWhiteListPath = Path.Combine(Directory.GetCurrentDirectory(), "Unit", "Text", "Sanitizer", "whitelist.json");
        ...
        {
            // given
            _textSettings.HtmlElementWhiteListPath = Path.Combine(Directory.GetCurrentDirectory(), "Unit", "Text", "Sanitizer", "dodgy-whitelist.json");
            var defaultSettings = _htmlWhiteListProvider.CreateDefaultWhiteList();
