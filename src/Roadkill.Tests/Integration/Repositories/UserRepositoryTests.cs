...
namespace Roadkill.Tests.Integration.Repositories
{
    public class UserRepositoryTests
    {
        ...
        public UserRepositoryTests()
        {
            ...
            new UserRepository(MartenDocumentStore).Wipe().GetAwaiter().GetResult();
        }

        public UserRepository CreateRepository()
        {
            return new UserRepository(MartenDocumentStore);
        }
        ...
        {
            // given
            await new UserRepository(MartenDocumentStore).Wipe();
        ...
        public async void GetAdminById_should_return_admin_user()
        {
            ...
            AssertEquivalent(expectedUser, actualUser);
        }
